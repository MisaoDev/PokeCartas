...
<body>
  ...
  <div class="container">
    <div class="jumbotron mt-4 py-4">
      ...
      <h1 class="text-center mb-4">Regístrate en PokeCartas</h1>
      ...
      <form action="/UsuarioController" class="needs-validation" novalidate method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <input type="text" name="iUsername" id="iUsername" class="form-control" required />
          <div class="valid-feedback">Todo bien</div>
          <div class="invalid-feedback">Ingresa un nombre de usuario válido (solo letras y números)</div>
          <div class="text-danger d-none" id="userExists">Este nombre de usuario ya existe. Por favor ingresa otro nombre.</div>
        </div>
        ...
        <div class="text-center">
          <img id="imgFoto" class="img-thumbnail foto-usuario-md d-none"
            src="" alt="" />
        </div>
        ...
        <div class="col mt-3 text-center">
          <button type="submit" class="btn btn-primary" name="action" value="register"
            onclick="btnNeedsValidation = true">
            Crear cuenta
          </button>
        </div>
  ...
  <script>
    ...
    <c:if test="${errUserExists}">
      $('#userExists').removeClass('d-none');
      $('#iUsername').focus();
    </c:if>
  </script>
